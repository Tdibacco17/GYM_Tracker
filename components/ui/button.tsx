  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        link: " underline-offset-4 hover:underline  text-[#9162c0]",
        hidden: 'w-full h-full',
        violetPrimary: "bg-[#9353D3]/60 text-primary shadow hover:bg-[#9353D3]/50",
        violet: "border border-[#9162c0]/30 bg-[#9162c025] text-[#9162c0] shadow-sm hover:bg-[#9162c0]/30 font-semibold leading-none tracking-tigh"
      },
      size: {
